  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:  AppBar(
          ...
          title: Text("Checkout", style: TextStyle(color: AppConstant.whiteColor),),
        ),
        body: 
           Container(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Obx(() => Text(DbKeyConstant.rs+"${cartController.totalProductPrice}"),)
                          ],
                        ),
                      ),      
                       ...
                       ElevatedButton(
                        ...
                        child: Text("Place Order",style: TextStyleConstant.bold16Style.copyWith(
                          color: ColorConstant.whiteColor
                        ),))
                    ],
                  ),
