        ...
        try{
            QuerySnapshot snapshot = await FirebaseFirestore.instance
             ...
             for(var singleDoc in documentList ) {
               ...
               Map<String,dynamic> docData =  singleDoc.data() as Map<String,dynamic>;
          ...
          SnackbarHelper.customSnackbar(titleMsg: "Order Confirmed!", msg: "Thank you for shopping! Have a nice day") ;  
          EasyLoading.dismiss();    
